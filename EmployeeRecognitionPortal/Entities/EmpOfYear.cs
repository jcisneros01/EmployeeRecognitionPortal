      ...
      public override void CreateLaTex()
      {
        ...
        s.Append(@"%========import packages============
            ...
            \begin{minipage}[c]{8in}
                \centering
                \onehalfspacing
                \Huge\bfseries\color{blue}{ Employee of the Year \\ \par}
            \end{minipage}
            \vskip .3em
            ...
            \begin{minipage}[c]{8in}
                ...
                \par
                \Huge\floweroneleft\quad{\decosix}\quad\floweroneright\par
            \end{minipage}
            \vskip 1em
        ...
        s.Append(@"}
            ...
            \centering
            \includegraphics[width=.5\linewidth,height=.25\linewidth]{sig.png}
